...
height_cm = st.number_input("กรอกส่วนสูงคุณ (เซนติเมตร):",min_value=1.0)
...
if st.button("คำนวณค่า BMI"):
   ...
   #ส่วนที่4 แปลผลค่า BMI ตามเกณฑ์
     if bmi < 18.5:
         ...
         st.success("คุณมีน้ำหนักอยู่นเกณฑ์ปกติ (สุขภาพดี)")
     elif 23.0 <= bmi < 25.0: 
...
st.divider()
st.write("นางสาว พรลภัส ต้องมีเกียรติกุล เลขที่33 ม.4/13")
